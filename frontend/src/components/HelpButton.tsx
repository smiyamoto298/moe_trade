...
export default function HelpButton() {
  ...
  return (
    <button
      ...
      className="fixed bottom-5 right-5 z-[900] w-11 h-11 rounded-full bg-primary-500 hover:bg-primary-600 text-white text-lg font-bold shadow-lg flex items-center justify-center transition-colors"
    >
      ?
    </button>
  )
