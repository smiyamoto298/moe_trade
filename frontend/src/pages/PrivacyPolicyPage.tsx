      ...
      <div className="bg-surface-card border border-surface-border rounded-lg p-6 text-sm text-gray-300 space-y-6 leading-relaxed">
        ...
        <section className="space-y-1">
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              通知先メールアドレス（メール通知の利用を希望された場合のみ。メールをお送りするには宛先の復元が必要なため、
              このアドレスに限り暗号化したうえで保存します。マイページの「通知設定」からいつでも変更・削除でき、
              削除するとメール通知は届かなくなります）
            </li>
        ...
        <section className="space-y-1">
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>メール通知を希望された利用者へ、取引に関する通知をお送りするため</li>
        ...
        <section className="space-y-1">
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              通知先メールアドレスの暗号化保存（メール通知を希望された場合のみ保持し、平文では保存しません）
            </li>
