...
// スマホではXアプリが x.com のリンクを引き受け（ユニバーサルリンク／アプリリンク）、
// アプリの投稿画面に文面が反映される。旧ディープリンク twitter://post?message=... は
// 現行のXアプリで本文が反映されないため使わない。
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-6">
      ...
      <p className="text-sm text-gray-400 mb-5">
        ...
        スマホではXアプリが入っていればアプリの投稿画面が開き、文面が反映されます（無い場合はブラウザの投稿画面）。
