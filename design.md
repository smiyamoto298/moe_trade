...
| `tests/Feature/AnnouncementApiTest.php` | お知らせ管理API（`link_new_tab` の作成・更新・デフォルト false = 同じウィンドウ・`target_type` の作成/正規化/バリデーション・公開一覧の対象ユーザー絞り込み all/staff/specific） |
